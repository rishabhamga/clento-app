-- Fix Leads Saving Issue
-- This fixes the upsert_lead_enhanced function to properly associate leads with users

-- Update the upsert function to handle user_id properly
