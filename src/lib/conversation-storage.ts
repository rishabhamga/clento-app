    ...
    createNewConversation(userId?: string, campaignId?: string): ConversationState {
        ...
        const conversation: ConversationState = {
            ...
            currentFilters: {
                ...
                // People filters (ApolloFilterInput)
                jobTitles: [],
                seniorities: [],
                personLocations: [],
                ...
                technologyUids: [],
                keywords: [],
                organizationNumJobsMin: 0,
                organizationNumJobsMax: 0,
                organizationJobPostedAtMin: 0,
                organizationJobPostedAtMax: 0,
                revenueMin: 0,
                revenueMax: 0,
                fundingStages: [],
                fundingAmountMin: 0,
                ...
                // Company filters (CompanyFilterInput)
