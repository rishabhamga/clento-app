...
function SearchResults({ className }: SearchResultsProps) {
    const { results, loading, error, searchType, pagination, companyResults } = useSearchResults()
                    ...
                    <Collapse in={isExpanded} animateOpacity>
                        <VStack spacing={4} align="stretch" pt={4}>
                            ...
                            <SimpleGrid columns={2} spacing={3}>
                                ...
                                {company.phone && (
                                    <HStack spacing={2}>
                                        <FiPhone color="gray" size={14} />
                                        <Text fontSize='sm' color="gray">Phone: {company.phone}</Text>
                                    </HStack>
                                )}
                            </SimpleGrid>
