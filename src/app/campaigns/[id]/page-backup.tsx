          ...
          <CardBody>
            <VStack spacing={4} align="stretch">
              ...
              <Box>
                ...
                <Text fontSize="sm">
                  {offering.description || pitch.coreOffering || campaign?.description || 'AI-powered sales development platform that automates outreach'}
                </Text>
              </Box>
              <Box>
                <Text fontSize="sm" fontWeight="semibold" color="gray.600" mb={2}>Pain Points Addressed</Text>
                <Text fontSize="sm">
                  {pitch.painPoints?.join(', ') || 'Manual outreach, low response rates, inefficient lead qualification'}
                </Text>
              </Box>
              <Box>
                <Text fontSize="sm" fontWeight="semibold" color="gray.600" mb={2}>Proof Points</Text>
                <Text fontSize="sm">
                  {pitch.proofPoints?.join(', ') || '3x higher response rates, 50% time savings, proven ROI'}
                </Text>
              </Box>
            </VStack>
          </CardBody>
            ...
            <VStack spacing={4} align="stretch">
              ...
              <SimpleGrid columns={{ base: 1, md: 2 }} spacing={4}>
                <Box>
                  ...
                  <Text fontSize="sm">
                    {messaging.emailSubjects?.length > 0 
                      ? messaging.emailSubjects.join(', ') 
                      : outreach.emailStrategy || 'Personalized based on company and role'}
                  </Text>
                </Box>
                <Box>
                  <Text fontSize="sm" fontWeight="semibold" color="gray.600" mb={2}>LinkedIn Messages</Text>
                  <Text fontSize="sm">
                    {messaging.linkedinMessages?.length > 0 
                      ? messaging.linkedinMessages.length + ' message templates'
                      : outreach.linkedinStrategy || 'AI-generated, contextual outreach'}
                  </Text>
                </Box>
                <Box>
                  <Text fontSize="sm" fontWeight="semibold" color="gray.600" mb={2}>Follow-up Strategy</Text>
                  <Text fontSize="sm">
                    {outreach.followupStrategy || messaging.followupSequence || 'Multi-touch sequence with delays'}
                  </Text>
                </Box>
                <Box>
                  <Text fontSize="sm" fontWeight="semibold" color="gray.600" mb={2}>Personalization</Text>
                  <Text fontSize="sm">
                    {outreach.personalization?.join(', ') || 'Company research, recent news, mutual connections'}
                  </Text>
                </Box>
              </SimpleGrid>
            </VStack>
            ...
            <VStack spacing={4} align="stretch">
              ...
              <SimpleGrid columns={{ base: 1, md: 2 }} spacing={4}>
                <Box>
                  ...
                  <Text fontSize="sm">
                    {campaign?.sequence_template || workflow.sequenceType || 'Aggressive Multi-Channel'}
                  </Text>
                </Box>
                <Box>
            ...
            <VStack spacing={4} align="stretch">
              ...
              <SimpleGrid columns={{ base: 1, md: 2 }} spacing={4}>
                ...
                <Box>
                  ...
                  <Text fontSize="sm">
                    {campaign?.sequence_template || launch.template || 'Aggressive Multi-Channel'}
                  </Text>
                </Box>
              </SimpleGrid>
            </VStack>
